...
namespace QRGenerator.Tags
{
    ...
    public class QRCodeTagHelper : TagHelper
    {
        public override void Process(TagHelperContext context, TagHelperOutput output)
        {
            ...
            Random r = new Random();
            int random = r.Next(111111, 999999);
            ...
            using (var bitmap = new Bitmap(pixelData.Width, pixelData.Height, System.Drawing.Imaging.PixelFormat.Format32bppRgb))
            {
                using (var memoryStream = new MemoryStream())
                {
                   ...
                   // Dictionary<string, string> QrDic = new Dictionary<string, string>();
                    ...
                    output.Attributes.Add("random", String.Format(random.ToString()));
